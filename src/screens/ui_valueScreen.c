...
lv_obj_set_y( ui_profileName, 100 );
lv_obj_set_align( ui_profileName, LV_TEXT_ALIGN_CENTER );
lv_label_set_long_mode(ui_profileName,LV_LABEL_LONG_SCROLL_CIRCULAR);
lv_label_set_text(ui_profileName,"GODOT STAMMTISCH - KARLSRUHE");
...
lv_label_set_text(ui_profileDesc,"VISCOUS HAPTIC DEMO WITH MULTI-REVOLUTION");
...
lv_label_set_text(ui_pressLab3,"CHANGE HAPTICS:");
...
lv_label_set_text(ui_keyShift2,"UNAVAILABLE");
